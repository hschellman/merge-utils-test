...
pydeps retriever.py -T png --include-missing --cluster --max-bacon 2 --rankdir BT
pydeps do_merge.py -T png --include-missing --cluster --max-bacon 2 --rankdir BT
pydeps config.py -T png --include-missing --cluster --max-bacon 2 --rankdir BT
pydeps scheduler.py -T png --include-missing --cluster --max-bacon 2 --rankdir BT
pydeps meta.py -T png --include-missing --cluster --max-bacon 2 --rankdir BT
